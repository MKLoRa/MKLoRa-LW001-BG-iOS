...
/**
 线程ID
 */
@property (nonatomic, assign)mk_bg_taskOperationID operationID;
...
- (instancetype)initOperationWithID:(mk_bg_taskOperationID)operationID
...
- (void)peripheral:(CBPeripheral *)peripheral didUpdateValueForCharacteristic:(CBCharacteristic *)characteristic {
    [self dataParserReceivedData:[MKBGTaskAdopter parseReadDataWithCharacteristic:characteristic]];
}

- (void)peripheral:(CBPeripheral *)peripheral didWriteValueForCharacteristic:(CBCharacteristic *)characteristic {
    [self dataParserReceivedData:[MKBGTaskAdopter parseWriteDataWithCharacteristic:characteristic]];
}
...
- (void)dataParserReceivedData:(NSDictionary *)dataDic{
    ...
    mk_bg_taskOperationID operationID = [dataDic[@"operationID"] integerValue];
    if (operationID == mk_bg_defaultTaskOperationID || operationID != self.operationID) {
        return;
    }
