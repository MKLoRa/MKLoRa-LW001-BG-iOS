...
@implementation MKBGTextButtonCellModel
@end

@interface MKBGTextButtonCell ()
...
@implementation MKBGTextButtonCell

+ (MKBGTextButtonCell *)initCellWithTableView:(UITableView *)tableView {
    MKBGTextButtonCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKBGTextButtonCellIdenty"];
    if (!cell) {
        cell = [[MKBGTextButtonCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKBGTextButtonCellIdenty"];
    }
    return cell;
}
...
- (void)rightButtonPressed {
    if ([self.delegate respondsToSelector:@selector(bg_textButtonCell_buttonAction:)]) {
        [self.delegate bg_textButtonCell_buttonAction:self.dataModel.index];
    }
}

#pragma mark - setter
- (void)setDataModel:(MKBGTextButtonCellModel *)dataModel {
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKBGTextButtonCellModel.class]) {
        return;
    }
