...
static MKBGUserLoginManager *loginManager = nil;
static dispatch_once_t onceToken;

@interface MKBGUserLoginManager ()
...
+ (MKBGUserLoginManager *)shared {
    dispatch_once(&onceToken, ^{
        if (!loginManager) {
            loginManager = [MKBGUserLoginManager new];
        }
    });
    return loginManager;
}
