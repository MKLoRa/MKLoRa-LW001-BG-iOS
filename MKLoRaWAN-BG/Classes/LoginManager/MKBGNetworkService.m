...
@implementation MKBGCreateLoRaDeviceModel
...
@interface MKBGNetworkService ()

@property (nonatomic, strong)NSURLSessionDataTask *addLoRaDeviceTask;

@end

@implementation MKBGNetworkService

+ (instancetype)share {
    static dispatch_once_t t;
    static MKBGNetworkService *service = nil;
    dispatch_once(&t, ^{
        service = [[MKBGNetworkService alloc] init];
    });
    return service;
}

- (void)addLoRaDeviceToCloud:(MKBGCreateLoRaDeviceModel *)deviceModel
