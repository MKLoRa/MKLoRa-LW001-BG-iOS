...
@interface MKBGBatteryConsumptionModel ()
...
@implementation MKBGBatteryConsumptionModel
...
- (BOOL)readCurrent {
    ...
    [MKBGInterface bg_readBatteryInformationWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readLast {
    __block BOOL success = NO;
    [MKBGInterface bg_readLastCycleBatteryInformationWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readAll {
    __block BOOL success = NO;
    [MKBGInterface bg_readAllCycleBatteryInformationWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
