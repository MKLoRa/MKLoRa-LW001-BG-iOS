...
@interface MKBGOptionsController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MKBGOptionsController

- (void)dealloc {
    NSLog(@"MKBGOptionsController销毁");
}
...
#pragma mark - UI
- (void)loadSubViews {
    self.defaultTitle = @"LW001-BG PRO";
