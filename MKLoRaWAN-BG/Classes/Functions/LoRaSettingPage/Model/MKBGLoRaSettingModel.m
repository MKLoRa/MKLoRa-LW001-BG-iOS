...
@implementation MKBGLoRaSettingConfigModel
...
@interface MKBGLoRaSettingModel ()

@property (nonatomic, strong)dispatch_queue_t readQueue;

@property (nonatomic, strong)dispatch_semaphore_t semaphore;

@property (nonatomic, strong)MKBGLoRaSettingConfigModel *configModel;

@end

@implementation MKBGLoRaSettingModel
...
- (BOOL)readModem {
    ...
    [MKBGInterface bg_readLorawanModemWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configModem {
    __block BOOL success = NO;
    [MKBGInterface bg_configModem:(self.modem - 1) sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readRegion {
    __block BOOL success = NO;
    [MKBGInterface bg_readLorawanRegionWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configRegion {
    __block BOOL success = NO;
    [MKBGInterface bg_configRegion:self.currentRegion sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readDevEUI {
    __block BOOL success = NO;
    [MKBGInterface bg_readLorawanDEVEUIWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configDevEUI {
    __block BOOL success = NO;
    [MKBGInterface bg_configDEVEUI:self.devEUI sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readAppEUI {
    __block BOOL success = NO;
    [MKBGInterface bg_readLorawanAPPEUIWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAppEUI {
    __block BOOL success = NO;
    [MKBGInterface bg_configAPPEUI:self.appEUI sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readAppKey {
    __block BOOL success = NO;
    [MKBGInterface bg_readLorawanAPPKEYWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAppKey {
    __block BOOL success = NO;
    [MKBGInterface bg_configAPPKEY:self.appKey sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readDevAddr {
    __block BOOL success = NO;
    [MKBGInterface bg_readLorawanDEVADDRWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configDevAddr {
    __block BOOL success = NO;
    [MKBGInterface bg_configDEVADDR:self.devAddr sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readAppSkey {
    __block BOOL success = NO;
    [MKBGInterface bg_readLorawanAPPSKEYWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAppSkey {
    __block BOOL success = NO;
    [MKBGInterface bg_configAPPSKEY:self.appSKey sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readMessageType {
    __block BOOL success = NO;
    [MKBGInterface bg_readLorawanMessageTypeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configMessageType {
    __block BOOL success = NO;
    [MKBGInterface bg_configMessageType:self.messageType sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readNwkSkey {
    __block BOOL success = NO;
    [MKBGInterface bg_readLorawanNWKSKEYWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configNwkSkey {
    __block BOOL success = NO;
    [MKBGInterface bg_configNWKSKEY:self.nwkSKey sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readCHValue {
    __block BOOL success = NO;
    [MKBGInterface bg_readLorawanCHWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configCHValue {
    __block BOOL success = NO;
    [MKBGInterface bg_configCHL:self.CHL CHH:self.CHH sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readDutyStatus {
    __block BOOL success = NO;
    [MKBGInterface bg_readLorawanDutyCycleStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configDutyStatus {
    __block BOOL success = NO;
    [MKBGInterface bg_configDutyCycleStatus:self.dutyIsOn sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readJoinValue {
    __block BOOL success = NO;
    [MKBGInterface bg_readLorawanDRWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configJoinValue {
    __block BOOL success = NO;
    [MKBGInterface bg_configDR:self.join sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readUplinkStrategy {
    __block BOOL success = NO;
    [MKBGInterface bg_readLorawanUplinkStrategyWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        self.adrIsOn = [returnData[@"result"][@"isOn"] boolValue];
        self.transmissions = [returnData[@"result"][@"transmissions"] integerValue];
...
- (BOOL)configUplinkStrategy {
    __block BOOL success = NO;
    [MKBGInterface bg_configUplinkStrategy:self.adrIsOn twice:(self.transmissions == 2) DRL:self.DRL DRH:self.DRH sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)restartDevice {
    __block BOOL success = NO;
    [MKBGInterface bg_restartDeviceWithSucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)checkParams {
    ...
    if (self.needAdvanceSetting) {
        ...
        if (self.DRL < 0 || self.DRL > 15 || self.DRH < self.DRL || self.DRH > 15) {
            return NO;
        }
    }
    return YES;
...
- (MKBGLoRaSettingConfigModel *)configModel {
    if (!_configModel) {
        _configModel = [[MKBGLoRaSettingConfigModel alloc] init];
    }
    return _configModel;
}
