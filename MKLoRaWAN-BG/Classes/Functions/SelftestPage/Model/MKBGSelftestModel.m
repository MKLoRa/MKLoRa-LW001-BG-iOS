...
@implementation MKBGSelftestModel
...
- (BOOL)readPCBAStatus {
    ...
    [MKBGInterface bg_readPCBAStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSelftestStatus {
    __block BOOL success = NO;
    [MKBGInterface bg_readSelftestStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
