...
@implementation MKBGSelftestCellModel
@end

@interface MKBGSelftestCell ()
...
@implementation MKBGSelftestCell

+ (MKBGSelftestCell *)initCellWithTableView:(UITableView *)tableView {
    MKBGSelftestCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKBGSelftestCellIdenty"];
    if (!cell) {
        cell = [[MKBGSelftestCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKBGSelftestCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKBGSelftestCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKBGSelftestCellModel.class]) {
        return;
    }
