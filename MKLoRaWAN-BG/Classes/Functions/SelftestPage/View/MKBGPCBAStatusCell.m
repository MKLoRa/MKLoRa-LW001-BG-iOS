...
@implementation MKBGPCBAStatusCellModel
@end

@interface MKBGPCBAStatusCell ()
...
@implementation MKBGPCBAStatusCell

+ (MKBGPCBAStatusCell *)initCellWithTableView:(UITableView *)tableView {
    MKBGPCBAStatusCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKBGPCBAStatusCellIdenty"];
    if (!cell) {
        cell = [[MKBGPCBAStatusCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKBGPCBAStatusCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKBGPCBAStatusCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKBGPCBAStatusCellModel.class]) {
        return;
    }
