...
@interface MKBGUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKBGDFUModule *dfuModule;
...
@implementation MKBGUpdateController

- (void)dealloc {
    NSLog(@"MKBGUpdateController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_bg_startDfuProcessNotification" object:nil];
...
- (void)updateComplete {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_bg_centralDeallocNotification" object:nil];
...
- (MKBGDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKBGDFUModule alloc] init];
    }
    return _dfuModule;
}
