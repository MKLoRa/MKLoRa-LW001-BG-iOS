...
@interface MKBGDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKBGDFUModule

- (void)dealloc{
    NSLog(@"MKBGDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKBGCentralManager shared].peripheral];
}
