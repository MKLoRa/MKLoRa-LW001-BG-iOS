...
static NSString *const MKBGSynDataCellIdenty = @"MKBGSynDataCellIdenty";

@interface MKBGSynDataCell ()
...
@implementation MKBGSynDataCell

+ (MKBGSynDataCell *)initCellWithTableView:(UITableView *)tableView {
    MKBGSynDataCell *cell = [tableView dequeueReusableCellWithIdentifier:MKBGSynDataCellIdenty];
    if (!cell) {
        cell = [[MKBGSynDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:MKBGSynDataCellIdenty];
    }
    return cell;
}
