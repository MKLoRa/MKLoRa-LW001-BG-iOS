...
@implementation MKBGMsgIconButton
...
@interface MKBGSynTableHeaderView ()
...
@property (nonatomic, strong)MKBGMsgIconButton *synButton;

@property (nonatomic, strong)MKBGMsgIconButton *emptyButton;

@property (nonatomic, strong)MKBGMsgIconButton *exportButton;
...
@implementation MKBGSynTableHeaderView
...
- (MKBGMsgIconButton *)synButton {
    if (!_synButton) {
        _synButton = [[MKBGMsgIconButton alloc] init];
        _synButton.topIcon.image = LOADICON(@"MKLoRaWAN-BG", @"MKBGSynTableHeaderView", @"bg_sync_enableIcon.png");
        _synButton.msgLabel.text = @"Sync";
    }
    return _synButton;
}

- (MKBGMsgIconButton *)emptyButton {
    if (!_emptyButton) {
        _emptyButton = [[MKBGMsgIconButton alloc] init];
        _emptyButton.topIcon.image = LOADICON(@"MKLoRaWAN-BG", @"MKBGSynTableHeaderView", @"bg_delete_enableIcon.png");
        _emptyButton.msgLabel.text = @"Empty";
    }
    return _emptyButton;
}

- (MKBGMsgIconButton *)exportButton {
    if (!_exportButton) {
        _exportButton = [[MKBGMsgIconButton alloc] init];
        _exportButton.topIcon.image = LOADICON(@"MKLoRaWAN-BG", @"MKBGSynTableHeaderView", @"bg_export_enableIcon.png");
