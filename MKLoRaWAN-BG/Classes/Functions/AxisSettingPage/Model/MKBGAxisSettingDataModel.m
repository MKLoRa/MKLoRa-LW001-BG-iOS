...
@interface MKBGAxisSettingDataModel ()
...
@implementation MKBGAxisSettingDataModel
...
- (BOOL)readWakeupConditions {
    ...
    [MKBGInterface bg_readThreeAxisWakeupConditionsWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configWakeupConditions {
    __block BOOL success = NO;
    [MKBGInterface bg_configThreeAxisWakeupConditions:[self.wakeupThreshold integerValue] duration:[self.wakeupDuration integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readMotionConditions {
    __block BOOL success = NO;
    [MKBGInterface bg_readThreeAxisMotionParametersWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configMotionConditions {
    __block BOOL success = NO;
    [MKBGInterface bg_configThreeAxisMotionParameters:[self.motionThreshold integerValue] duration:[self.motionDuration integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readVibrationThresholds {
    __block BOOL success = NO;
    [MKBGInterface bg_readVibrationThresholdsWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configVibrationThresholds {
    __block BOOL success = NO;
    [MKBGInterface bg_configVibrationThresholds:[self.vibrationThresholds integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
