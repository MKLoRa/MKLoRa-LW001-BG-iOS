...
@implementation MKBGMotionModeEventsModel
@end

@interface MKBGMotionModeModel ()
...
@implementation MKBGMotionModeModel
...
- (BOOL)readMotionModeEvents {
    ...
    [MKBGInterface bg_readMotionModeEventsWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configMotionModeEvents {
    ...
    [MKBGInterface bg_configMotionModeEvents:eventModel sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readNumberOfFixOnStart {
    __block BOOL success = NO;
    [MKBGInterface bg_readMotionModeNumberOfFixOnStartWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configNumberOfFixOnStart {
    __block BOOL success = NO;
    [MKBGInterface bg_configMotionModeNumberOfFixOnStart:[self.numberOfFixOnStart integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPosStrategyOnStart {
    __block BOOL success = NO;
    [MKBGInterface bg_readMotionModePosStrategyOnStartWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        self.posStrategyOnStart = [self getPositioningStrategy:[returnData[@"result"][@"strategy"] integerValue]];
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
    }];
...
- (BOOL)configPosStrategyOnStart {
    __block BOOL success = NO;
    [MKBGInterface bg_configMotionModePosStrategyOnStart:self.posStrategyOnStart sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readReportIntervalInTrip {
    __block BOOL success = NO;
    [MKBGInterface bg_readMotionModeReportIntervalInTripWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configReportIntervalInTrip {
    __block BOOL success = NO;
    [MKBGInterface bg_configMotionModeReportIntervalInTrip:[self.reportIntervalInTrip longLongValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPosStrategyInTrip {
    __block BOOL success = NO;
    [MKBGInterface bg_readMotionModePosStrategyInTripWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        self.posStrategyInTrip = [self getPositioningStrategy:[returnData[@"result"][@"strategy"] integerValue]];
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
    }];
...
- (BOOL)configPosStrategyInTrip {
    __block BOOL success = NO;
    [MKBGInterface bg_configMotionModePosStrategyInTrip:self.posStrategyInTrip sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readTripEndTimeout {
    __block BOOL success = NO;
    [MKBGInterface bg_readMotionModeTripEndTimeoutWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configTripEndTimeout {
    __block BOOL success = NO;
    [MKBGInterface bg_configMotionModeTripEndTimeout:[self.tripEndTimeout integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readNumberOfFixOnEnd {
    __block BOOL success = NO;
    [MKBGInterface bg_readMotionModeNumberOfFixOnEndWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configNumberOfFixOnEnd {
    __block BOOL success = NO;
    [MKBGInterface bg_configMotionModeNumberOfFixOnEnd:[self.numberOfFixOnEnd integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readReportIntervalOnEnd {
    __block BOOL success = NO;
    [MKBGInterface bg_readMotionModeReportIntervalOnEndWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configReportIntervalOnEnd {
    __block BOOL success = NO;
    [MKBGInterface bg_configMotionModeReportIntervalOnEnd:[self.reportIntervalOnEnd integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPosStrategyOnEnd {
    __block BOOL success = NO;
    [MKBGInterface bg_readMotionModePosStrategyOnEndWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        self.posStrategyOnEnd = [self getPositioningStrategy:[returnData[@"result"][@"strategy"] integerValue]];
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
    }];
...
- (BOOL)configPosStrategyOnEnd {
    __block BOOL success = NO;
    [MKBGInterface bg_configMotionModePosStrategyOnEnd:self.posStrategyOnEnd sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
