...
@implementation MKBGPeriodicModeController

- (void)dealloc {
    NSLog(@"MKBGPeriodicModeController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-BG", @"MKBGPeriodicModeController", @"bg_slotSaveIcon.png") forState:UIControlStateNormal];
