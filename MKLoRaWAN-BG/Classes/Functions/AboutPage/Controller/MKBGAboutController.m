...
@implementation MKBGAboutController

- (void)dealloc {
    NSLog(@"MKBGAboutController销毁");
}
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKLoRaWAN-BG", @"MKBGAboutController", @"bg_aboutIcon.png");
    }
    return _aboutIcon;
}
...
- (UILabel *)firmwareLabel{
    if (!_firmwareLabel) {
        ...
        _firmwareLabel.text = @"FW Version:V2.0";
    }
...
- (UIImageView *)bottomIcon {
    if (!_bottomIcon) {
        ...
        _bottomIcon.image = LOADICON(@"MKLoRaWAN-BG", @"MKBGAboutController", @"bg_aboutBottomIcon.png");
    }
    return _bottomIcon;
}
