...
@implementation MKBGActiveStateController

- (void)dealloc {
    NSLog(@"MKBGActiveStateController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-BG", @"MKBGActiveStateController", @"bg_slotSaveIcon.png") forState:UIControlStateNormal];
