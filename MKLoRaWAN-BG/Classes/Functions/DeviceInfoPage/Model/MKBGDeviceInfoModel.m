...
@implementation MKBGDeviceInfoModel
...
- (BOOL)readBatteryPower {
    ...
    [MKBGInterface bg_readBatteryLevelWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readMacAddress {
    __block BOOL success = NO;
    [MKBGInterface bg_readMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readDeviceModel {
    __block BOOL success = NO;
    [MKBGInterface bg_readDeviceModelWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSoftware {
    __block BOOL success = NO;
    [MKBGInterface bg_readSoftwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHardware {
    __block BOOL success = NO;
    [MKBGInterface bg_readHardwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManu {
    __block BOOL success = NO;
    [MKBGInterface bg_readManufacturerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
